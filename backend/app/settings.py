...
DATABASES = {
    'default': {
        ...
        # CONN_MAX_AGE: Reuse connections for 60 seconds
        'CONN_MAX_AGE': int(os.getenv('DB_CONN_MAX_AGE', '60')),
        # Disable server-side cursors for compatibility with connection pooling
...
# Timeouts
STREAM_TIMEOUT_SECONDS = int(os.getenv('STREAM_TIMEOUT_SECONDS', '600'))
APPROVAL_WAIT_TIMEOUT_SECONDS = int(os.getenv('APPROVAL_WAIT_TIMEOUT_SECONDS', '30'))
SSE_HEARTBEAT_SECONDS = int(os.getenv('SSE_HEARTBEAT_SECONDS', '15'))

# Rate Limiting
MAX_CONCURRENT_STREAMS_PER_USER = int(os.getenv('MAX_CONCURRENT_STREAMS_PER_USER', '10'))

# Redis
REDIS_PUBLISH_CONCURRENCY = int(os.getenv('REDIS_PUBLISH_CONCURRENCY', '100'))
