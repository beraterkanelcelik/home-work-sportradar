...
def index_document(document_id: int, user_id: int) -> None:
    """
    ...
    # Determine embedding client (use mock if no API key)
    import os
    ...
    try:
        ...
        # Step 4: Embed chunks
        with langfuse_trace("embed_chunks", {'document_id': document_id, 'chunk_count': len(chunk_objects)}):
